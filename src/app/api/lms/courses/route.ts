...
const STATIC_COURSES: CourseEntry[] = [
  // ── Nhóm: Khóa học (giá hời — hiển thị đầu tiên) ──
  {
    ...
    group: 'courses',
    urls: [
      'https://drive.google.com/drive/folders/1tGz7lgPCExvjjvA9b9GHDowQzgXt3FsF', // 1.09 Hành trình tử vi (Mộc Đầu)
      'https://drive.google.com/drive/folders/1cPA4kpT-Se4Z_gX0I3FWG7QpPL2cyzAW', // 1.20 Tử vi Cơ bản (Tống Nguyên Trung)
    ],
  },
  {
    id: 'khoahoc-group-2',
    ...
    group: 'courses',
    urls: [
      'https://drive.google.com/drive/folders/1rmO1MvNP7Ti1PFpZFCeszllBZo6UBpH', // 2.09 Master Bát Tự Nguyễn Dũng
      'https://drive.google.com/drive/folders/19ghqBqRZxHc0nhgWXzanNyjks29i1jh5', // 5.02 Kỳ Môn Độn Giáp (1)
      'https://drive.google.com/drive/folders/18jupHfTnR1kuH3C-wySyToAN8NaTkZqB', // 5.02 Kỳ Môn Độn Giáp (2)
    ],
  },
